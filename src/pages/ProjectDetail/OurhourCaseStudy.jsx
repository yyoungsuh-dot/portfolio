...
const CONTENT = {
  ko: {
    ...
    problem: {
      ...
      paragraphs: [
        '휠체어를 이용하는 지체 장애 부모와 유아차를 이용하는 어린 자녀의 외출에는 수많은 물리적 제약이 따릅니다. 휠체어와 유아차를 동시에 조작하기 어렵고, 두 제품이 차지하는 큰 부피로 인해 좁은 길이나 통로에서의 이동도 쉽지 않습니다. 또한 안전한 이동을 위해 주변 환경에 지속적으로 주의를 기울여야 하기에 아이와의 상호작용 역시 제한됩니다. 아이를 유아차에서 자동차 등 다른 위치로 옮기는 과정 또한 많은 힘이 필요하며 안전사고의 위험이 따릅니다.',
      ],
