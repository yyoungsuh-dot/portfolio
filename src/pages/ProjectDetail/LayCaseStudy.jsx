...
const CONTENT = {
  ko: {
    overview: {
      ...
      paragraphs: [
        '언어가 다른 친구와 대화 중 스마트폰으로 번역기를 켜거나, 책을 읽던 중 모르는 단어를 노트북에서 다시 타이핑해 검색한 경험이 있을 것입니다. 이렇듯 일상의 편리한 기능들은 대부분 디지털에 한정되어 있어, 하던 행동을 중단하고 스크린을 열어야 하는 번거로운 단절이 발생합니다. 이러한 간극은 작업을 번거롭게 만들 뿐만 아니라 몰입을 방해하며, 오프라인 환경에서만 얻을 수 있는 창의성을 놓치게 만듭니다.',
        '​',
